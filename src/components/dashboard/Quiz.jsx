              ...
              <div className="py-30 px-30">
                <div className="border-light overflow-hidden rounded-8">
                  <div className="py-40 px-40 bg-dark-5">
                    <div className="d-flex justify-between">
                      ...
                      <div className="d-flex x-gap-50">
                        <div className="d-flex items-center text-white">
                          ...
                          <div>Marcar Questão</div>
                        </div>
                        <div className="d-flex items-center text-white">
                          <div className="icon-edit mr-10"></div>
                          <div>Editar Questão</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="d-flex pt-15">
                      ...
                      <div className="text-white ml-50">Pontuação máxima: 1.00</div>
                    </div>

                    <div className="text-20 lh-1 text-white mt-15">
                      Você está assistindo ao noticiário e vê isso aparecer na
                      tela:
                    </div>
                  </div>

                  <div className="px-40 py-40">
                    <div className="mb-30">Selecione uma:</div>
                ...
                <div className="border-light overflow-hidden rounded-8 mt-30">
                  ...
                  >
                    <div className="d-flex items-center">
                      <div>
                        Se eu quiser enviar mensagens curtas com menos de 140
                        caracteres, eu uso
                      </div>
                    ...
                    <div className="d-flex items-center mt-20">
                      <div>Se eu quiser compartilhar fotos rapidamente, eu posso usar</div>
                    ...
                    <div className="d-flex items-center mt-20">
                      <div>
                        Se eu quiser fazer uma videochamada no meu iPhone, eu posso usar
                      </div>
                ...
                <div className="border-light overflow-hidden rounded-8 mt-30">
                  <div className="py-40 px-40 bg-dark-5">
                    ...
                    <div className="text-20 lh-1 text-white mt-15">
                      Associe os ícones aos seus sites.
                    </div>
                  </div>
                ...
                <div className="border-light overflow-hidden rounded-8 mt-30">
                  ...
                  <div className="px-40 py-40">
                    <div className="mb-20">Selecione uma:</div>
